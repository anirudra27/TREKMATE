...
class ItineraryAdmin(admin.ModelAdmin):
    list_display = ('i_id', 'destination', 'itinerary', 'detail_itinerary', 'season', 'cost', 'difficulty', 'location', 'duration', 'map_image')
    search_fields = ['destination', 'season', 'location', 'duration']
    fields = ('i_id', 'destination', 'itinerary', 'detail_itinerary', 'season', 'location', 'difficulty', 'cost', 'duration', 'map_image')
